    ...
    <div className="grid gap-6 md:grid-cols-2">
      <Card className="overflow-hidden border-none shadow-lg">
        <div className="bg-gradient-to-r from-[#8A2BE2] to-[#9932CC] dark:from-[#4B0082] dark:to-[#663399] p-4 text-white">
          <CardTitle>Filiales con Más Fallos</CardTitle>
        </div>
      ...
      <Card className="overflow-hidden border-none shadow-lg">
        <div className="bg-gradient-to-r from-[#8A2BE2] to-[#9932CC] dark:from-[#4B0082] dark:to-[#663399] p-4 text-white">
          <CardTitle>Hosts con Más Fallos</CardTitle>
        </div>
        <CardContent className="pt-6">
          {sortedHostStats.length > 0 ? (
            <div className="h-[300px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                    data={sortedHostStats.slice(0, 5)}
                    cx="50%"
                    cy="50%"
                    labelLine={false}
                    ...
                    nameKey="hostname"
                  >
                    {sortedHostStats.slice(0, 5).map((entry, index) => (
