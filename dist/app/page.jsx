      ...
      <main className="container mx-auto py-8 px-4">
        <Tabs defaultValue="branch" className="w-full">
          <TabsList className="grid w-full max-w-md mx-auto grid-cols-2 mb-8 rounded-full bg-muted/20 p-1">
            <TabsTrigger value="branch" className="rounded-full data-[state=active]:bg-[#8A2BE2] data-[state=active]:text-white dark:data-[state=active]:bg-[#4B0082]">
              Filiales
            </TabsTrigger>
            <TabsTrigger value="stats" className="rounded-full data-[state=active]:bg-[#8A2BE2] data-[state=active]:text-white dark:data-[state=active]:bg-[#4B0082]">
              Estadísticas
            </TabsTrigger>
          </TabsList>
